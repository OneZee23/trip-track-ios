...
**Platform:** iOS (iPhone)
**Status:** v0.6.3 в ревью App Store (3 сентября, билд 54) · v0.6.4 «Паспорт машины» в работе | **Started:** Jan 2026
...
- [ ] Поля `Vehicle`: имя машины, «про неё», архив/продана, марка/модель/год/кузов, оси видимости фото и карты
- [ ] Схема CoreData v9 + миграция
- [ ] Фотографии машины: галерея, главная, отдельная ось приватности
- [ ] Свой гараж: одна активная машина, остальные в архиве, переключение руками
- [ ] Чужой гараж и паспорт: рекорды «что видела эта машина», подписка на машину
- [ ] Бэкенд: `photos_visible`, гейт `?vehicleId=`, жалоба на машину и снимок, рекорды считает сервер
