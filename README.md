...
**Platform:** iOS (iPhone)
**Status:** v0.6.4 «Паспорт машины» в сторе · v0.6.5 «До моря — за сколько?» готова к сабмиту (билд 57, бэкенд ждёт деплоя) | **Started:** Jan 2026
...
### v0.6.5 «До моря — за сколько?» — готово к сабмиту
...
- [ ] Тег `v0.6.5` — на коммит, который уйдёт билдом 57
...
- [ ] Сущность «путешествие» как окно дат над своими поездками (v11): ничего не
      копируется, итоги считаются из плеч, отметки остаются в своих поездках
- [ ] Создание руками, ретроактивно: с экрана поездки («Объединить в
      путешествие», соседи ±7 дней) и мультивыбором в «Мои»
- [ ] Экран путешествия: карта всех плеч, «6 дней · 1 640 км · 6 поездок»,
      лента по дням → плечи → отметки; местные поездки в точке назначения
      свёрнуты в строку
