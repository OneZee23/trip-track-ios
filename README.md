...
- [x] Поля `Vehicle`: имя машины, «про неё», архив/продана, марка/модель/год/кузов, оси видимости фото и карты
- [x] Схема CoreData v9 + миграция
- [x] Фотографии машины: галерея, главная, отдельная ось приватности, загрузка на сервер
- [x] Свой гараж: активная / остальные / архив — архив стал состоянием, а не подписью
...
- [ ] **Монетизация: одна активная машина бесплатно.** Механика архива уже
      построена и работает; лимит — одна строка в `SettingsManager.recordableVehicles`.
