...
**Platform:** iOS (iPhone)
**Status:** v0.6.5 «До моря — за сколько?» в ревью (билд 57, бэкенд выкачен) · v0.6.6 «Путешествие» в работе (билд 58) | **Started:** Jan 2026
...
- [x] Сущность «путешествие» как окно дат над своими поездками (схема v12):
      ...
      в своих поездках
- [x] Создание руками, ретроактивно: с экрана поездки («Объединить в
      путешествие», соседи ±7 дней) и мультивыбором в «Мои»
- [x] Экран путешествия: карта-склейка всех плеч с кружками отметок, итог
      («дни · километры · поездки · время в пути»), лента по дням → плечи →
      отметки; местные поездки в точке назначения свёрнуты в строку; правка
      имени/дат/обложки; удаление путешествия не трогает поездки
