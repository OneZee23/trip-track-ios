...
### v0.6.2 — своё лицо (отправлен в App Store)
...
### v0.6.4 — паспорт машины (в работе)
...
- [ ] Подписка на машину — перенесено, отдельная фича
- [ ] Монетизация «одна активная машина бесплатно» — 0.6.5, когда появится магазин
