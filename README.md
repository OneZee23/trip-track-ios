...
**Platform:** iOS (iPhone)
**Status:** v0.6.3 в ревью App Store (3 сентября, билд 54) · v0.6.4 «Паспорт машины» собрана локально (билд 55), ждёт деплоя бэкенда | **Started:** Jan 2026
...
### v0.6.3 — чужой профиль целиком (в ревью с 3 сентября, билд 54)
