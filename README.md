...
**Platform:** iOS (iPhone)
**Status:** v0.6.2 (branding, vehicle set) · v0.6.1 in App Store | **Started:** Jan 2026
...
- [x] Тесты: каталоги, матрица спрайтов, совместимость формата, замеры, история уровней, имена иллюстраций
