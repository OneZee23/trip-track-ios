...
struct SharedTripLinkSheet: View {
    ...
    var body: some View {
        ...
        // The ground is painted by the sizer, not here: the detent runs a
        // little past the measured content, and a background that stopped at
        // the content left a band of the system's own sheet colour under the
        // buttons.
