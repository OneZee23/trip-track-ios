...
Релиз по фидбэку пользователей: смена авто у поездок, надёжный старт нужной машины из Siri/Команд, устойчивость сессии к разлогину на нестабильной сети, шеринг для гостей, переименование разделов.
